...
export default function AddToWishlist({ product }) {
  ...
  return (
    <button
      ...
      type="button"
      className="inline-flex items-center px-2 py-2  text-gray-900 bg-white border  border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700"
    >
